...
has 'PANEL_NAME' => (isa => 'Str', is => 'rw', default => 'reader1panel' );
...
#	my $_pmgr = $winframe->_pmgr_handle();
	my $_smgr = $_pmgr->_stateManager();
#	my $frame_key = $winframe->wxframe_key_value();
#	my $settings = $_wfmgr->_wx_gui_type_settings($frame_key);
